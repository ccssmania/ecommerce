                                                              ...
                                                              @foreach($order->shopping_cart->in_shopping_carts as $in)
	                                                              <tr mc:repeatable>
                                                                	...
                                                                	@if(isset($in->medida_id) && $in->medida->precio > 0)
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00"> ${{$in->medida->precio}} </td>
																	@else
																		<td valign="top" class="dataTableContent" mc:edit="data_table_content00">${{$in->product->pricing}} </td>
																	@endif
                                                                  	<td valign="top" class="dataTableContent" mc:edit="data_table_content00">
                                                                  		{{$in->cantidad}}
                                                                  	</td>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Ver más informacón</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                    ...
                                                    <tr>
                                                        <td valign="top">
                                                            <div mc:edit="std_footer">
																<em>Copyright &copy; CCSS , All rights reserved.</em>
																<br />

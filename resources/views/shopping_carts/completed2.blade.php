...
@section("content")
	...
	<div class="container">
		<div class="card large-padding">
			...
			<div class="text-center top-space"> <h1>-------Datos De Transferencia -----</h1> </div>
			<div class="row large-padding">
				<div class="col-xs-6">Banco</div>
				<div class="col-xs-6"> {{$contact->banco}} </div>
			</div>
			<div class="row large-padding">
				<div class="col-xs-6">Cuenta</div>
				<div class="col-xs-6"> {{$contact->no_cuenta}} </div>
			</div>
